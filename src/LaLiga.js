...
export class PremierLeague extends React.Component {
	...
	onTermSubmit = async (term) => {
		await fetch(`https://api-football-beta.p.rapidapi.com/standings?season=${term}&league=140`, {
			method: 'GET',
			headers: {
		...
		await fetch(`https://api-football-beta.p.rapidapi.com/players/topscorers?season=${term}&league=140`, {
			method: 'GET',
			headers: {
				'x-rapidapi-key': 'a30015a5d7msh46aa926867118ffp1a38c5jsn6aa106dccbbc',
				'x-rapidapi-host': 'api-football-beta.p.rapidapi.com'
